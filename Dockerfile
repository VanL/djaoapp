...
RUN set -eux; \
      ...
      /app/bin/pip install boto3==1.33.13 Django==4.2.18 django-phonenumber-field==7.1.0 django-recaptcha==4.0.0 djangorestframework==3.15.2 djaodjin-deployutils==0.12.0 djaodjin-extended-templates==0.4.8 djaodjin-multitier==0.2.1 djaodjin-rules==0.4.8 djaodjin-saas==1.0.2 djaodjin-signup==0.9.10 docutils==0.15.2 drf-spectacular==0.27.0 googlemaps==4.10.0 gunicorn==23.0.0 jinja2==3.1.5 phonenumbers==8.13.17 PyJWT==2.10.1 pyotp==2.8.0 pytz==2025.1 social-auth-app-django==5.4.2 whitenoise==6.4.0 WeasyPrint==53.4 django-storages==1.14.2; \
